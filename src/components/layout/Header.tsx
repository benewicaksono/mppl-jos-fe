            ...
            <li>
              {isAuthenticated == false ? (
                ...
                <Menu as='div'>
                  ...
                  >
                    <Menu.Items className='layout absolute mt-2 w-56 origin-top-right translate-x-[-48] divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'>
